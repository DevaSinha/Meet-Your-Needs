    ...
    return (<div class="container">
        ...
        <form className="form-control" >
            ...
            <div class="ms-5">
                ...
                Enter Your Email Id :  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                <TextField type="email" name="email1"
            ...
            <div class="ms-5">
                ...
                <TextField type="password" name="cpassword"
            ...
            <div class="ms-5">
                ...
                <TextField type="text" name="nationality"
            ...
            <div class="ms-5">
                Enter Pincode :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <TextField type="number" name="pincode"
            ...
            <div class="ms-5">
                ...
                <TextField type="text" name="answer" id="answer" placeholder="Your Answer" onChange={(event) => setAnswer(event.target.value)} />

                <p style={{ display: state.security.touched && state.security.hasError ? "block" : "none", color: "red" }}> {state.security.error} </p>
                <br />
                <br />

                <TextField type="submit" value="Register" disabled={state.isFormValid ? false : true} onClick={sendData}
                />  &nbsp; &nbsp;
                <TextField type="reset" value="Clear"
